...
var viewModel = function() {
	...
	modelData.pageTitle(modelData.daysOfWeek[modelData.title.getDay()] + ", " + modelData.daysOfMonth[modelData.title.getMonth()] + " " + modelData.title.getDate() + "   (" + modelData.title.getHours() + ":" + modelData.title.getMinutes() + ")");  // observable for the title in the header	
	console.log(eventList);
	console.log("here");
	//octopus.calendarList();
